...
public class ApplicationProperties {
            ...
            put("default", new Properties() {
                {
                    ...
                    //application URL's
                    setProperty(ApplicationProperty.APP_URL.name, "http://craiglist.org");
                    setProperty(ApplicationProperty.APP_URL2.name, "https://helsinki.craigslist.fi/d/housing/search/hhh?lang=en&cc=gb");
                    ...
                    setProperty(ApplicationProperty.TEST_DATA.name, "house");

                    setProperty(ApplicationProperty.TEST_USER_NAME.name, "");
                    setProperty(ApplicationProperty.TEST_USER_PASSWORD.name, "");
    ...
    public enum ApplicationProperty {
        ...
        ENV("env"), APP_URL("appUrl"), APP_URL2("appUrl2"), BROWSER("browser"),
